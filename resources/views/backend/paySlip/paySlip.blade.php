...
<div class="ps-3 pb-4">
    ...
    <div class="bg-white w-full mt-1 px-14 pt-10 pb-40 shadow rounded-tl-2xl rounded-tr-2xl rounded-bl-0 rounded-br-0">
        ...
        <div class="bg-white w-full pb-4 border border-[#DDD] rounded-lg">
            ...
            <div class="flex items-center justify-center gap-3 mt-12">
                <div class="border border-[#BABABA] rounded relative w-full lg:w-[35%] pe-4 ps-1">
                    ...
                    <input type="text" class="w-full py-3 ps-1 pe-5 border-none focus:outline-none text-black text-13" placeholder="হোল্ডিং নং">
                </div>
                
                <div class="border border-[#BABABA] rounded relative w-full lg:w-[35%] pe-4 ps-1">
                    <label for="holding_number" class="text-15 font-ubontu text-[#0E1F1C] leading-4 absolute -top-[12%] left-[5%] bg-white">দাখিলা</label>
                    <input type="text" class="w-full py-3 ps-1 pe-5 border-none focus:outline-none text-black text-13" placeholder="দাখিলা">
                </div>
            </div>

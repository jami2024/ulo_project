...
<div class="ps-3 pb-4 rounded-tl-2xl rounded-tr-2xl rounded-bl-0 rounded-br-0">
    <div class="bg-[#198754] py-4 px-3">
    ...
    <div class="border border-[#7ECBA1] bg-white rounded shadow px-3 py-2 mt-1">
        <div class="flex items-center justify-between">
            <h3 class="text-[#198754] font-ubontu text-16 leading-4">আর্কাইভ হোল্ডিং এর অনুসন্ধান</h3>

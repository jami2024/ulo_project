...
<div class="ps-3 pb-4">
    <div class="bg-[#198754] py-4 px-3 rounded-tl-2xl rounded-tr-2xl rounded-bl-0 rounded-br-0">
        <h1 class="text-white text-24 leading-6 text-center">আর্কাইভ হোল্ডিং বিবরণ</h1>
    </div>
    <div class="border border-[#7ECBA1] bg-white rounded shadow px-3 py-2 mt-1">
        <div class="flex items-center justify-between">
            <h3 class="text-[#198754] font-ubontu text-16 leading-4">আর্কাইভ হোল্ডিং এর বিস্তারিত অনুসন্ধান</h3>
            <a href="{{ route('holding.acchiveListTwo') }}" class="text-[#A5008A] font-ubontu text-16 flex items-center gap-1 underline">বিস্তারিত অনুসন্ধান
        ...
        <div class="flex flex-wrap items-center lg:gap-4 xl:gap-6 py-3">
            ...
            <div class="border border-[#BABABA] rounded relative w-full lg:w-[23%] pe-4 ps-1">
                <label for="holding_number" class="text-15 font-ubontu text-[#0E1F1C] leading-4 absolute -top-[12%] left-[5%] bg-white">হোল্ডিং নং</label>
                <input type="text" class="w-full py-3 ps-1 pe-5 border-none focus:outline-none text-black text-13" placeholder="নম্বর লিখুন">
            </div>
            <div class="border border-[#BABABA] rounded relative w-full lg:w-[23%] pe-4 ps-1">
                <label for="holding_number" class="text-15 font-ubontu text-[#0E1F1C] leading-4 absolute -top-[12%] left-[5%] bg-white">খতিয়ান নং</label>
                <input type="text" class="w-full py-3 ps-1 pe-5 border-none focus:outline-none text-black text-13" placeholder="নম্বর লিখুন">
            </div>
            <div class="border border-[#BABABA] rounded relative w-full lg:w-[23%] pe-4 ps-1">
                <label for="holding_number" class="text-15 font-ubontu text-[#0E1F1C] leading-4 absolute -top-[12%] left-[5%] bg-white">দাগ নং</label>
                <input type="text" class="w-full py-3 ps-1 pe-5 border-none focus:outline-none text-black text-13" placeholder="নম্বর লিখুন">
            </div>
            ...
            <div class="border border-[#BABABA] rounded relative w-full lg:w-[23%] pe-4 ps-1">
                <label for="mouza" class="text-15 font-ubontu text-[#0E1F1C] leading-4 absolute -top-[12%] left-[5%] bg-white">বকেয়া ধরন</label>
                <select name="mouza" id="mouza" class="w-full py-3 ps-1  border-none focus:outline-none text-[#BABABA] text-13">
                    <option value="">নির্বাচন করুন</option>
                    <option value="mouza1">মৌজা ১</option>
                    <option value="mouza2">মৌজা ২</option>
    ...
    <div class="border border-[#7ECBA1] bg-white rounded shadow px-3 py-2 mt-1">
        <div class="flex items-center justify-start">
            <h3 class="text-[#198754] font-ubontu text-14 leading-4">আর্কাইভ হোল্ডিং বিবরণ</h3>
                        ...
                        <tr >
                            ...
                            <td class="text-center">
                              <div class="flex items-center justify-end gap-1">
                                  ...
                                  <a href=""  class="flex items-center gap-1 bg-[#2AB752] py-1 px-3 rounded">
                                      <span class="text-[#FFEAEA] text-13 font-ubontu">পূর্বাবস্থায় ফেরত</span>

...
<div class="ps-3 pb-4">
    ...
    <div class="bg-white w-full pb-4 border border-[#DDD] rounded-lg mt-1">
        ...
        <div class="flex items-center  gap-4 mt-6 px-10">
            ...
            <a href="{{ route('citizen.khotianDetails') }}" class="cursor-pointer flex items-center gap-1 border border-[#12633D] bg-[#12633D] py-2 px-5 rounded font-ubontu text-white text-15">
    ...
    <div class="border border-[#7ECBA1] bg-white rounded-md mt-1">
        <h1 class="text-16 text-[#198754] font-ubontu leading-4 text-center py-2">নাগরিক কতৃক খতিয়ান সমূহ</h1>
        <div class="py-4">
                ...
                <table class="table table-xs table-pin-rows table-pin-cols">
                  <thead>
                    <tr>
                      ...
                      <td class="text-center border-r border-gray-400"><span class="text-[#0E1F1C] text-14 font-ubontu">তারিখ</span></td> 

...
<div class="ps-3 pb-4">
    <div class="bg-[#198754] py-4 px-3 rounded-tl-2xl rounded-tr-2xl rounded-bl-0 rounded-br-0">
        <h1 class="text-white text-24 leading-6 text-center">অনুমোদিত হোল্ডিং বিবরণ</h1>
    </div>
    <div class="border border-[#7ECBA1] bg-white rounded shadow px-3 py-2 mt-1">
        <div class="flex items-center justify-between">
            <h3 class="text-[#198754] font-ubontu text-16 leading-4">অনুমোদিত হোল্ডিং এর বিস্তারিত অনুসন্ধান</h3>
            <a href="{{ route('holding.acceptedListTwo') }}" class="text-[#A5008A] font-ubontu text-16 flex items-center gap-1 underline">বিস্তারিত অনুসন্ধান
    ...
    <div class="border border-[#7ECBA1] bg-white rounded shadow px-3 py-2 mt-1">
        <div class="flex items-center justify-between">
            <h3 class="text-[#198754] font-ubontu text-14 leading-4">অনুমোদিত হোল্ডিং বিবরণ</h3>
